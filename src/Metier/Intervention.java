...
public class Intervention implements IFacturable {
	...
	public Intervention(int id, Date dateDebut, Date dateFin, String description, String statut, Vehicule vehicule,
			Mecanicien mecanicien, double prixMainOeuvre) {
		this.id = id;
	...
	public double getPrixMainOeuvre() {

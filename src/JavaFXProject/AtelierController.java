...
public class AtelierController {
	...
	@FXML
	private TableView<Intervention> tableAtelier;
	@FXML
	private TableColumn<Intervention, String> colVehicule, colDesc, colStatut, colMeca;
	@FXML
	private TableColumn<Intervention, java.util.Date> colDateDeb, colDateFin;

	@FXML
	private Button btnNouvelleIntervention, btnTerminer, btnFactures;
	@FXML
	...
	private void chargerDonnees() {
		...
		colVehicule.setCellValueFactory(c -> new SimpleStringProperty(
				c.getValue().getVehicule().getMarque() + " " + c.getValue().getVehicule().getModele()));
	...
	private void handleNouvelleIntervention() {
		openPopup("FormulaireIntervention.fxml");
	}
